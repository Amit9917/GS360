...
**Client:** [CLIENT_COMPANY_NAME] ("Client")
...
The objective of this SLA is to ensure uninterrupted system performance, quick issue resolution, and continuous operational efficiency for [CLIENT_COMPANY_NAME]'s diagnostic workflows.
...
- Each individual task must not exceed **[ENHANCEMENT_TASK_MAX_HOURS] hours** of effort
- A maximum of **[ENHANCEMENT_MONTHLY_CAP_HOURS] hours per month** of cumulative enhancement effort is included
- Any task exceeding [ENHANCEMENT_TASK_MAX_HOURS] hours, or effort exceeding the monthly cap, will be treated as a Change Request (CR) per Section 12
...
24/7 support available only for Severity 1 (Critical) issues. Emergency support outside standard business hours may be charged at **1.5x the CR hourly rate** ([EMERGENCY_HOURLY_RATE]/hour) if the issue is subsequently determined to be caused by Client infrastructure, unauthorized changes, or factors outside Provider's application scope.
...
- The SLA covers a maximum of **[SUPPORT_MONTHLY_CAP_HOURS] support hours per month** for issue resolution and maintenance (excluding minor enhancements defined in Section 2.5)
...
- If the Client exceeds the monthly support cap, the Provider reserves the right to:
  - Charge additional hours at the CR rate ([CR_HOURLY_RATE]/hour)
...
- All CRs will be charged at a rate of [CR_HOURLY_RATE]/hour (exclusive of applicable taxes)
...
- CR invoices are payable within [CR_PAYMENT_DAYS] days of invoice date
...
- Annual SLA Fee: [SLA_ANNUAL_FEE] ([SLA_ANNUAL_FEE_WORDS] only), exclusive of applicable GST (currently [GST_PERCENTAGE]%)
- Total payable (inclusive of GST): [SLA_TOTAL_WITH_GST] ([SLA_TOTAL_WITH_GST_WORDS] only)
...
A notice shall be deemed delivered on the date of email delivery (with read receipt or delivery confirmation), or 3 business days after dispatch via registered post/courier, whichever is earlier.

Designated contacts:

- Provider: [PROVIDER_CONTACT_NAME], [PROVIDER_CONTACT_DESIGNATION] — [PROVIDER_CONTACT_EMAIL]
- Client: [CLIENT_SPOC_NAME] — [CLIENT_SPOC_EMAIL]
...
Replace these tokens before finalizing the document:

| Placeholder | Description | Suggested Value |
|---|---|---|
| [CLIENT_CONTACT_NAME] | Client's addressee name | Mr. Gagandeep Gupta |
| [CLIENT_COMPANY_NAME] | Client's company name | Scan4Health |
| [EFFECTIVE_DATE] | Agreement start date | 25/03/2026 |
| [MONTH] | Document month | Mar |
| [YEAR] | Document year | 2026 |
| [ENHANCEMENT_TASK_MAX_HOURS] | Max hours per enhancement task | 4 |
| [ENHANCEMENT_MONTHLY_CAP_HOURS] | Monthly enhancement hours cap | 20 |
| [SUPPORT_MONTHLY_CAP_HOURS] | Monthly support hours cap | 30 |
| [CR_HOURLY_RATE] | Change Request hourly rate | ₹2,000 |
| [EMERGENCY_HOURLY_RATE] | Emergency after-hours rate (1.5x CR) | ₹3,000 |
| [CR_PAYMENT_DAYS] | CR invoice payment term (days) | 15 |
| [SLA_ANNUAL_FEE] | Annual SLA fee (excl. GST) | ₹1,50,000/- |
| [SLA_ANNUAL_FEE_WORDS] | Fee in words | Rupees One Lakh Fifty Thousand |
| [GST_PERCENTAGE] | Applicable GST rate | 18 |
| [SLA_TOTAL_WITH_GST] | Total payable incl. GST | ₹1,77,000/- |
| [SLA_TOTAL_WITH_GST_WORDS] | Total in words | Rupees One Lakh Seventy-Seven Thousand |
| [SUPPORT_EMAIL] | Support email address | tech@attention.sh |
| [PROVIDER_CONTACT_NAME] | Provider's notice contact | Amit Joshi |
| [PROVIDER_CONTACT_DESIGNATION] | Provider contact title | COO |
| [PROVIDER_CONTACT_EMAIL] | Provider contact email | — |
| [PROVIDER_SIGNATORY_NAME] | Provider's signing authority | Amit Joshi |
| [PROVIDER_SIGNATORY_DESIGNATION] | Signatory title | COO |
| [CLIENT_SPOC_NAME] | Client's SPOC for notices | — |
| [CLIENT_SPOC_EMAIL] | Client's SPOC email | — |
| [SIGNING_DATE] | Date of signing | 25/03/2026 |
